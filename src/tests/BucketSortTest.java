import exam.SortingAlgorithms.BucketSort;
...
public class BucketSortTest {
    ...
    public void testFillBucketsOneElement() {
        ...
        assertEquals(42, buckets[0].peek());
    }
    ...
    public void testFillBucketsTwoElements() {
        ...
        assertEquals(21, buckets[0].peek());
        assertEquals(42, buckets[21].peek());
    }
    ...
    public void testFillBucketsThreeElements() {
        ...
        // Check one bucket has been created
        assertEquals(22, buckets.length);
        assertEquals(21, buckets[0].poll());
        assertEquals(42, buckets[21].poll());
        assertEquals(42, buckets[21].poll());
    }
