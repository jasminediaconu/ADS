...
public class AdaptablePQ {
     ...
     *
     * @param vertex exam.Dijkstra.Vertex to add to the queue.
     ...
     *
     * @param vertex exam.Dijkstra.Vertex to change the key from.
     ...
     *
     * @return the removed entry's exam.Dijkstra.Vertex and its key (or null if the PQ is empty).
     */
